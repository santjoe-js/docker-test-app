...
//		return "democonfiserver";
		...
		employeeObj.setEmployeeid("1");
		employeeObj.setFirstName("fn");
		employeeObj.setMaritalStatus(true);
		employeeObj.setSalary(10000);
		employeeRepository1.save(employeeObj);
		return new ResponseEntity<String>("This is a String insered", HttpStatus.OK);
